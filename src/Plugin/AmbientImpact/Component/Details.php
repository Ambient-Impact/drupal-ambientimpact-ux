  ...
  public function getDemo(): array {
    ...
    return [
      ...
      '#demo' => [
        ...
        [
          '#title' => $this->t(
            'This is not styled but <em>is</em> animated',
          ),
          '#description'  => [
            'boring' => [
              '#type'   => 'html_tag',
